...
ssh ${SERVER_ADDRESS} -p 2200 "mkdir -p $TARGET_PATH"

rsync -av -e "ssh -p 2200" --exclude ".git" --exclude "cmake-build-debug" --exclude "docs/html" --exclude ".idea" "." "$SERVER_ADDRESS:$TARGET_PATH/"
