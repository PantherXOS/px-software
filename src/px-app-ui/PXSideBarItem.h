...
public:
    ...
    PXSideBarItem(const QString &title, ItemType itemType, PxQScrollArea *view, QListWidget *parent = nullptr) : QListWidgetItem (parent){
        this->view = view;
        _title=title;
